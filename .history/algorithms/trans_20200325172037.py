...
def transform(name, height, weight, pos, stl, reb, ast, fouls, dunk, efgp):
    ...
    reb = reb
    pas = ast
    phy = 0.1*fouls + 0.3*get_height(height) + 0.4*get_weight(weight) + 0.2*drib
...
if __name__ == "__main__":
    ...
    print(sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4], sys.argv[5], sys.argv[6], sys.argv[7], sys.argv[8], sys.argv[9], sys.argv[10])