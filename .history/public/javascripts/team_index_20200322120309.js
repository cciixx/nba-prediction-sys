$(document).ready(function(){
    $.ajax({
        ...
        for(var i=0;i<data.length;i++){
            ...
            teams_code = data[i].teams_code
            $("#title").append("<a href = 'team.html?t_code="+teams_code+"' target='_blank'><div class='A_team'><img src='" + img_src +"'> <div class='name_T'>"+ team_name+"</div></div></a>")
        }
        }
    })
})
